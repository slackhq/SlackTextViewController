...
- (void)configureSubviews
{
    ...
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-padding-[thumbnailView(tumbSize)]-(>=0)-|" options:0 metrics:metrics views:views]];
